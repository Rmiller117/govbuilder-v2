  ...
  <div class="min-h-screen bg-gray-50">
      ...
      <div class="max-w-5xl mx-auto px-6 py-6 flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          <router-link
            ...
            class="px-5 py-3 bg-purple-600 text-white font-medium rounded-xl hover:bg-purple-700 transition flex items-center gap-2"
          >
    ...
    <main class="max-w-5xl mx-auto px-6 py-12">
      ...
      <div v-if="!list.length" class="text-center py-20">
        ...
        <h3 class="text-xl font-semibold text-gray-700 mb-2">No inspection types yet</h3>
...
const { list, remove } = useInspectionTypeStore()
const { list: workflowList } = useInspectionWorkflowStore()

const workflows = computed(() => Object.fromEntries(workflowList.value.map(w => [w.id, w.name])))

function workflowName(id?: string) {
  return id ? workflows.value[id] : undefined
}
